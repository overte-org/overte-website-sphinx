...
The current release of Overte is version 2024.11.1.
...
.. button-link:: https://public.overte.org/build/overte/release/2024.11.1/Overte-2024.11.1-x86_64.AppImage
    :shadow:
    :color: primary
...
.. button-link:: https://public.overte.org/build/overte/release/2024.11.1/Overte-2024.11.1.exe
    :shadow:
    :color: primary
