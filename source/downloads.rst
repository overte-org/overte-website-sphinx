...
The current release candidate of Overte is version 2024.10.2-rc1.
...
.. button-link:: https://overte-public.fra1.digitaloceanspaces.com/build/overte/release-candidate/2024.10.2-rc1/Overte-2024.10.2-rc1-x86_64.AppImage
    :shadow:
    :color: primary
...
Select the appropriate package for your distribution and architecture from `public.overte.org 🔗 <https://public.overte.org/index.html#build/overte/release-candidate/2024.10.2-rc1/>`_.
...
.. button-link:: https://overte-public.fra1.digitaloceanspaces.com/build/overte/release-candidate/2024.10.2-rc1/Overte-2024.10.2-rc1.exe
    :shadow:
    :color: primary
