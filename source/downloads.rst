...
The current release candidate of Overte is version 2023.11.1-rc7.
This release includes complete replacement of script engine and a lot of other improvements. 
On server side stable build 2022.12.1 is still recommended but testing and reporting bugs on 2023.11.1-rc7 is very welcome.
...
.. button-link:: https://public.overte.org/build/overte/release-candidate/2023.11.1-rc7/Overte-2023.11-rc7-nodebug-x86_64.AppImage
    :shadow:
    :color: primary
...
.. button-link:: https://public.overte.org/build/overte/release-candidate/2023.11.1-rc7/Overte-2023.11.1-rc7.exe
    :shadow:
    :color: primary
