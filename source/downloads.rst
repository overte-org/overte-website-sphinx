...
The current release of Overte is version 2025.09.1.
...
Select the appropriate package for your distribution and architecture from `public.overte.org 🔗 <https://public.overte.org/index.html#build/overte/release/2025.09.1/>`_.
...
.. button-link:: https://public.overte.org/build/overte/release/2025.09.1/Overte-2025.09.1.exe
    :shadow:
    :color: primary
